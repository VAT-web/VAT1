Feature: Aviva application- POS Aviva Dhan Suraksha- LI=PRO- WITHEkyc
  ...
  @PRODUCT
  Scenario: POS Aviva Dhan Suraksha- CONTINUATION- From Self/Reference home page
...
#    And Selected the Age of Life Insured or Policy Holder in Need Analysis tab
    ...
    And Down to Bottom
    And Select the product Pos Dhansuraksha
    And CLick on BI button
    And Click proceed in alert
    And Down to Bottom
    And Annual premium Dhansuraksha
    And Clicked on BI Generate Button Dhansuraksha
    And Scroll to TOP
