...
public class ReimbursementClaim {
    public static void main(String[] args) throws InterruptedException {
        ...
        Thread.sleep(2000);
         ...
         //Click on Inward from side menu
        driver.findElement(By.xpath("//*[@id=\"app\"]/div[1]/main/div/div/div[1]/div[1]/nav/div[1]/div[9]/div[1]")).click();

        //Click on Inward soft copy from side menu
        driver.findElement(By.xpath("//*[@id=\"app\"]/div[1]/main/div/div/div[1]/div[1]/nav/div[1]/div[9]/div[2]/a[1]/div")).click();

        //To click the Inward Soft-copy Button
        driver.findElement(By.xpath("//*[@id=\"app\"]/div[2]/main/div/div/div[1]/div[1]/nav/div[1]/div[9]/div[2]/a[1]")).click();
        ...
        Thread.sleep(500);
        driver.findElement(By.xpath("//div[@class='v-date-picker-table v-date-picker-table--date theme--light']//button//div[text()='01']")).click();
...
//        Thread.sleep(1000);
      ...
      /*  //Select intimation - Hospitalization details tab
        ...
        //Party is hospital checkbox - -Invoice addition screen
