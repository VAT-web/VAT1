Feature: Aviva POS-Signature Guaranteed(NON-POS)-LI=PRO- WITHOUTEkyc
  ...
  @PRODUCT
  Scenario: 3D term(NON-POS) - CONTINUATION- From Self/Reference home page
