Feature: ASIP- LI≠PRO- WitheKYC
  ...
  Scenario: New Lead Creation
    ...
    And Click radio button of Details Of The Life Insured Two
    And I Selected checkbox Proceed with eKYC LI Two
    And I entered Adhar No LI Two
    And Cliked on Verify button LI Two
    And I wait for 30 sec to enter the otp
    And I selected the Title LI Two
    And I Selected the Title as MR LI Two
    And Down to Bottom
  ...
  Scenario: ASIP- CONTINUATION- From Self/Reference home page
    ...
    And Enter the lead id LiProDiffW
...
#    And Selected the Age of Life Insured or Policy Holder in Need Analysis tab
    ...
    And I Selected the Plan type Signature Millennial
    And Premium Payment Option Regular Premium
    And PolicyTerm 60
    And Cover Level 10
    And Selected Payment frequency Annual
    And Annual Premium 1212
    And Selected the Plan type Signature GenX
    And Premium Payment Option Regular Premium
    And Cover Level 10
    And Selected Payment frequency Annual
    And Annual Premium
